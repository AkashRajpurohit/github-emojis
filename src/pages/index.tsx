...
const Index = () => (
  ...
  <Head>
    ...
    <meta name='description' content='Search shortcodes of emojis supported by Github' />
    ...
    <meta name='keywords' content='github emojis, emojis in github, github commit emojis, github icons for commits' />
  </Head>
  <Container>
    <Hero />
    <DarkModeSwitch />
